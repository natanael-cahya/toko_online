    ...
    <div class="card">
      <div class="card-body">
        ...
        <form action="" class="form-inline" method="post">
          ...
          <a href="<?php echo base_url('/admin/trade'); ?>" class="ml-2 mb-2">Reset</a>
      </div>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <form name="fgz"  method="post" action="<?= base_url('admin/trade/tb_temp'); ?>">
        <?php foreach($trade as $par){ $para = $par->id_transaksi;  ?>
        <input type="hidden" name="par" value="<?= $para ?>">
        <?php } ?>
        <div id="view">
        
          <?php if(isset($_POST['z'])){ $this->load->view('admin/tabel_barang', array('tempe' => $tempe)); }else{} // Load file view.php dan kirim data siswanya 
          ?>
...
<div class="container-fluid">
    ...
    <thead>
      ...
      <tr>
        <th colspan="9" class="text-center">
          ...
          <a href="<?= base_url('admin/trade/hapus_all/'); if(empty($kdx)){echo"";}else{echo $kdx;} ?>" class="float-right btn btn-danger">Reset Keranjang</a>
          <?php  ?>
        </th>
      </tr>
      <tr>
      ...
      foreach ($trade as $m) : ?>
        <tr class="text-center">
          ...
          <td>
            ...
            <a class="btn btn-danger btn-sm" href="<?= base_url('admin/trade/hapus/');
  ...
  <hr>
   <form method="post" action="<?= base_url('admin/trade/tb_nota'); ?>">
  ...
  <?php foreach($trade as $g){ ?>
    ...
    <input type="hidden" name="id_buku[]" value="<?= $g->id_buku ?>">
        ...
        <div class="modal-body">
          <form action="<?= base_url('admin/data_belanja/update'); ?>" name="f1" method="post" enctype="multipart/form-data">
            <div class="form-group">
              ...
              <input type="text" name="namae" class="form-control" value="<?= $m->judul_brg ?>">
            </div>
