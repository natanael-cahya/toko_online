  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url('dashboard/tambah_ke_keranjang/'); echo $brg->id_buku ?>" name="f1" method="post" enctype="multipart/form-data" >
            
        <div class="form-group">
                <label>JUMLAH BELI</label>

                <select class="form-control" name="jb">
                <?php $zz = $brg->stok;  for($i=1;$i<=$zz;$i++){ ?>
                    <option><?= $i ?></option>
                    <?php } ?>
                </select>
            </div>     
