    ...
    <tbody>
      ...
      foreach ($barang as $brg) : ?>
        <tr <?= $brg->keterangan == '' ? "style='background-color:	#FFC0CB;'" : "" ?>>
          ...
          <td>
            <a class="btn btn-info btn-sm"  data-toggle="modal" data-target="#qr<?= $brg->id_brg ?>"><i class="fa fa-barcode"></i></a>
            <a class="btn btn-secondary btn-sm" href="<?= base_url('admin/data_barang/edit/');
                                                      echo $brg->id_brg ?>"><i class="fas fa-edit"></i></a>
            <a class="btn btn-danger btn-sm" href="<?= base_url('admin/data_barang/hapus/');
                                                    echo $brg->id_brg ?>"><i class="fas fa-trash"></i></a>
...
<!-- Modal QR -->
<div class="modal fade" id="qr<?= $brg->id_brg ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">QRCODE PRODUK</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
          ...
          <div class="form-group">
           <img src="<?= base_url('/assets/images/'); ?><?php echo $brg->qrcode ?>" width="470px" height="470px">
          </div>
